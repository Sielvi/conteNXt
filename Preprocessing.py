# -*- coding: utf-8 -*-
"""
Created on Fri Dec 17 17:21:06 2021
...
#lemmatizer =Lemmatizer(LEMMA_INDEX)
...
#stpwords=stopwords.words('english') + list(string.punctuation) + list(string.digits)
...
#consumer_key = "cR0ZnfIb1LWCQ2rpLRUtWBnGC"
#consumer_secret = "dNiTV5K2CSHGTL3E1l42K2OSRnRWNgrZZVGkCYTQkAgBM9ch9t"
#access_key = "953338671935062016-XqTEWKJyZPRYNWiDPcveFYgpGVsEZCI"
#access_secret = "NGyMjKnZTac1DN6J077cJtU16wFWsfGt8IC9W7ieeowOF"
...
#f=open("Preprocessed_dataset","w", encoding='utf-8')
count=0
#with open("C:\\Users\\Sielvie\\.spyder-py3\\Dec21\\Experiment\\4_timewindows\\09_hour.json", 'r') as handle:
#    json_data = [json.loads(line) for line in handle]
#
## 
#with open("1_AFTER_TEMPORAL_BINNG\\12_hour.jsonall_tokens.txt", 'r', encoding="utf-8") as handle:
#     phrases = [line.rstrip('\n') for line in handle]
import os
...
#    file1=open("tester_folder\\"+file+"_preprocessing.txt", "w", encoding="utf-8")
    print("----file", file)
    count=0
    final_phrases=[]  
    for line in phrases:
...
#              print("-----line", count)
    ...
    #          hashtag_1=spilthash.findall(tweet)
    #          tweet= re.sub(r"#(\w+)","",str(tweet))
    #          hashtag = ",".join(str(x) for x in hashtag_1)
    #          spiltment = re.compile(r"@(\w+)")
    #          mentions_1=spiltment.findall(tweet)
    #          tweet= re.sub(r"@(\w+)","",str(tweet))
    #              print(tweet, "-----raw tweet")
    #          mentions = ",".join(str(x) for x in mentions_1)
